                ...
                <form onSubmit={handleLogin} className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-6 mt-4">
                    ...
                    <div className="w-full flex items-center justify-between py-5">
                        ...
                        <div>
                            ...
                            <input aria-labelledby="email" type="email" name="email"  placeholder="Email"  className="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"/>
                        </div>
                        <div className="mt-6  w-full">
                           ...
                           <div className="relative flex items-center justify-center">
                            <input id="pass" type="password" name="password" type="password" placeholder="Password" className="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"/>
